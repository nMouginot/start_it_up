...
class ProjetObjectifsSlide extends FlutterDeckSlideWidget {
  ...
  ProjetObjectifsSlide({super.key, required this.block})
    : super(
        configuration: FlutterDeckSlideConfiguration(
          route: '/projet-${block.projet.id}',
        ),
      );
    ...
    return FlutterDeckSlide.blank(
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            Text(projet.name, style: theme.textTheme.displaySmall),
