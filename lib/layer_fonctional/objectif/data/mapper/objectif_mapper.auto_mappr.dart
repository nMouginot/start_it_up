...
/// {@template package:start_it_up/layer_fonctional/objectif/data/mapper/objectif_mapper.dart}
/// Available mappings:
/// - `ObjectifDto` → `Objectif`.
/// - `Objectif` → `ObjectifDto`.
/// {@endtemplate}
class $ObjectifMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:start_it_up/layer_fonctional/objectif/data/mapper/objectif_mapper.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    final sourceTypeOf = _typeOf<SOURCE>();
    final targetTypeOf = _typeOf<TARGET>();
    if ((sourceTypeOf == _typeOf<_i2.ObjectifDto>() ||
            sourceTypeOf == _typeOf<_i2.ObjectifDto?>()) &&
        (targetTypeOf == _typeOf<_i3.Objectif>() ||
            targetTypeOf == _typeOf<_i3.Objectif?>())) {
      return true;
    }
    if ((sourceTypeOf == _typeOf<_i3.Objectif>() ||
            sourceTypeOf == _typeOf<_i3.Objectif?>()) &&
        (targetTypeOf == _typeOf<_i2.ObjectifDto>() ||
            targetTypeOf == _typeOf<_i2.ObjectifDto?>())) {
      return true;
    }
    if (recursive) {
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i2.ObjectifDto>() ||
      ...
      return (_map__i2$ObjectifDto_To__i3$Objectif((model as _i2.ObjectifDto?))
          as TARGET);
    }
    if ((sourceTypeOf == _typeOf<_i3.Objectif>() ||
            sourceTypeOf == _typeOf<_i3.Objectif?>()) &&
      ...
      return (_map__i3$Objectif_To__i2$ObjectifDto((model as _i3.Objectif?))
          as TARGET);
    }
  ...
  _i3.Objectif _map__i2$ObjectifDto_To__i3$Objectif(_i2.ObjectifDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
  ...
  _i2.ObjectifDto _map__i3$Objectif_To__i2$ObjectifDto(_i3.Objectif? input) {
    final model = input;
    if (model == null) {
      throw Exception(
