...
import 'package:start_it_up/layer_fonctional/user/data/dto/user_dto.dart'
    as _i2;
import 'package:start_it_up/layer_fonctional/user/domain/entity/user.dart'
    as _i3;

/// {@template package:start_it_up/layer_fonctional/user/data/mapper/user_mapper.dart}
/// Available mappings:
/// - `UserDto` → `User`.
/// - `User` → `UserDto`.
/// {@endtemplate}
class $UserMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:start_it_up/layer_fonctional/user/data/mapper/user_mapper.dart}
  @override
