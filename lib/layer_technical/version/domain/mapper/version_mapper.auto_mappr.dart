...
import 'package:start_it_up/layer_technical/version/data/dto/version_dto.dart'
    as _i2;
import 'package:start_it_up/layer_technical/version/domain/version.dart' as _i3;

/// {@template package:start_it_up/layer_technical/version/domain/mapper/version_mapper.dart}
/// Available mappings:
/// - `VersionDto` → `Version`.
/// - `Version` → `VersionDto`.
/// {@endtemplate}
class $VersionMapper implements _i1.AutoMapprInterface {
  const $VersionMapper();
  ...
  /// {@macro package:start_it_up/layer_technical/version/domain/mapper/version_mapper.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    final sourceTypeOf = _typeOf<SOURCE>();
    final targetTypeOf = _typeOf<TARGET>();
    if ((sourceTypeOf == _typeOf<_i2.VersionDto>() ||
            sourceTypeOf == _typeOf<_i2.VersionDto?>()) &&
        (targetTypeOf == _typeOf<_i3.Version>() ||
            targetTypeOf == _typeOf<_i3.Version?>())) {
      return true;
    }
    if ((sourceTypeOf == _typeOf<_i3.Version>() ||
            sourceTypeOf == _typeOf<_i3.Version?>()) &&
        (targetTypeOf == _typeOf<_i2.VersionDto>() ||
            targetTypeOf == _typeOf<_i2.VersionDto?>())) {
      return true;
    }
    if (recursive) {
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i2.VersionDto>() ||
      ...
      return (_map__i2$VersionDto_To__i3$Version((model as _i2.VersionDto?))
          as TARGET);
    }
    if ((sourceTypeOf == _typeOf<_i3.Version>() ||
            sourceTypeOf == _typeOf<_i3.Version?>()) &&
      ...
      return (_map__i3$Version_To__i2$VersionDto((model as _i3.Version?))
          as TARGET);
    }
  ...
  _i3.Version _map__i2$VersionDto_To__i3$Version(_i2.VersionDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
  ...
  _i2.VersionDto _map__i3$Version_To__i2$VersionDto(_i3.Version? input) {
    final model = input;
    if (model == null) {
      throw Exception(
